...
class_names = ["banana", "apple", "pear", "grapes", "orange", "kiwi", "watermelon", "pomegranate", "pineapple", "mango",
               "cucumber", "carrot", "capsicum", "onion", "potato", "lemon", "tomato", "raddish", "beetroot", "cabbage",
...
# train the model
# we start with a 10 epochs , but probably will update the number to a bigger one during the sessions
...
test_loss, test_acc = model.evaluate(test_data, test_data_labels,
                                     verbose=1)  # verbose is a paramter of how detailed is the log in the console
